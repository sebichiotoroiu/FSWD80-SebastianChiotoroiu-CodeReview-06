...
var Places = /** @class */ (function () {
    function Places(name, image, address, price, hours, date) {
        this.name = "";
        this.image = "";
        this.address = "";
        this.price = "";
    ...
    Places.prototype.display = function (extension) {
...
var Restaurant = /** @class */ (function (_super) {
    ...
    function Restaurant(name, image, address, price, hours, phone, website, date) {
        var _this = _super.call(this, name, image, address, price, hours, date) || this;
        _this.phone = phone;
        _this.website = website;
        return _this;
    }
    Restaurant.prototype.display = function (extension) {
        return _super.prototype.display.call(this, "<p>Phone: " + this.phone + "</p> <p> Website: <a href=\"" + this.website + "\" target=\"_blank\">" + this.website + "</a> </p> " + extension);
    };
    return Restaurant;
}(Places));
var eachRestaurant = [
...
var Events = /** @class */ (function (_super) {
    ...
    function Events(name, image, address, price, hours, phone, website, type, date) {
        var _this = _super.call(this, name, image, address, price, hours, phone, website, date) || this;
        _this.type = type;
        return _this;
    }
    Events.prototype.display = function () {
        return _super.prototype.display.call(this, "<p>Type of Event: " + this.type + "</p>");
    };
    return Events;
}(Restaurant));
var eachEvent = [
...
var sortare = [eachLocation, eachRestaurant, eachEvent];
console.log(sortare);
//Ascending sorting 
function ascSort() {
    for (var i = 0; i < sortare.length; i++) {
